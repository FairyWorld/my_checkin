...
if [ ! -f "/ql/data/config/FairyWorld_my_checkin_main/config.yml" ]; then
 ...
 cp -r /ql/data/repo/FairyWorld_my_checkin_main/config.yml.temple /ql/data/config/FairyWorld_my_checkin_main/config.yml
else
 echo "已存在配置文件"
 echo "生成空白模板 /ql/data/config/FairyWorld_my_checkin_main/config.yml.sample"
 cp -r /ql/data/repo/FairyWorld_my_checkin_main/config.yml.temple /ql/data/config/FairyWorld_my_checkin_main/config.yml.sample
fi
